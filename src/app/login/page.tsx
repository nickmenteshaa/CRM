  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mt-4 bg-white border border-gray-200 rounded-xl p-4 space-y-2 text-xs text-gray-500">
          ...
          <div className="flex justify-between">
            ...
            <span className="bg-blue-100 text-blue-700 rounded-full px-2 py-0.5 font-medium">Sales</span>
          </div>
        </div>
      </div>
    </div>
